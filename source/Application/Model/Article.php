...
class Article extends \OxidEsales\Eshop\Core\Model\MultiLanguageModel implements \OxidEsales\Eshop\Application\Model\Contract\ArticleInterface, \OxidEsales\Eshop\Core\Contract\IUrl
{
    ...
    protected function assignStock()
    {
        ...
        if (
            ...
            if ($stock > 0 && ($this->isLowStock() || $this->isLowStockByShop())) {
    ...
    {
        return $this->_blNotBuyableParent ? $this->oxarticles__oxvarstock->value : $this->oxarticles__oxstock->value;
    }

    private function isLowStock(): bool
    {
        return $this->oxarticles__oxlowstockactive->value
            && $this->getAvailableStock() <= $this->oxarticles__oxremindamount->value;
    }

    private function isLowStockByShop(): bool
    {
        return !$this->oxarticles__oxlowstockactive->value
            && $this->getAvailableStock() <= Registry::getConfig()->getConfigParam('sStockWarningLimit');
    }
}
